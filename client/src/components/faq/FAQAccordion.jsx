              ...
              return (
                ...
                >
                  <button
                    ...
                    id={`tab-${category.id}`}
                    className={`px-3 py-2 md:px-4 md:py-2.5 rounded-xl font-bold text-xs md:text-sm transition-all duration-300 ${
                      isActive
                ...
                {faqData[activeCategory].map((faq, index) => (
                  ...
                  >
                    <button
                      ...
                      className="w-full px-4 md:px-10 py-4 md:py-6 flex items-center justify-between text-left transition-all duration-300 focus:outline-none focus:bg-primary/5"
                      aria-expanded={openFAQ === faq.id}
                      aria-controls={`faq-answer-${faq.id}`}
                      id={`faq-question-${faq.id}`}
                    >
                      <span
                        className={`font-bold text-sm md:text-lg pr-4 transition-colors duration-300 ${
                    ...
                    <AnimatePresence initial={false}>
                      {openFAQ === faq.id && (
                        ...
                        >
                          <div className="px-4 md:px-10 pb-6 md:pb-8 text-gray-700 text-xs md:text-base leading-relaxed">
                            {faq.answer}
                          </div>
                        </motion.div>
                      )}
