...
export default function FatLossSection() {
  return (
    <section className="relative w-full py-10 px-4 sm:px-6 md:px-8 bg-gradient-to-b from-slate-50 via-white to-teal-50/20 overflow-hidden">
      {/* Background glow */}
      ...
      <div className="relative max-w-6xl mx-auto">
          ...
          {features.map((item, i) => {
            ...
            return (
              <motion.div key={i} variants={itemVariants} className="group">
                <div className="relative h-[360px] cursor-pointer rounded-xl overflow-hidden shadow-xl hover:shadow-2xl transition-shadow duration-500 bg-gray-100">
                  {/* Background Image */}
                  <div 
                  ...
                  <div className="relative z-10 flex flex-col items-center justify-end h-full p-6 md:p-8 pb-10 text-center text-white">
                    <div className="w-16 h-16 md:w-16 md:h-16 mb-4  flex items-center justify-center rounded-xl bg-white/20 backdrop-blur-md border border-white/20 group-hover:bg-[#3E7D72]/80 group-hover:border-[#3E7D72]/50 transition-all duration-500">
        ...
        >
          <Link to="/contact" className="inline-flex items-center gap-2 bg-[#3E7D72] hover:bg-[#2f5f56] text-white font-bold py-3 px-5 rounded-xl text-sm md:text-base transition-all duration-300 hover:scale-105 hover:shadow-xl active:scale-95">
