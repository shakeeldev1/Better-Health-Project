...
const EbookCard = ({ title, price, tag, color, bgImage }) => (
  <div className="group relative overflow-hidden rounded-2xl h-[200px] shadow-sm hover:shadow-2xl transition-all  duration-500 flex flex-col justify-end p-6 border border-slate-100">
    ...
    <div className="relative z-10 space-y-2">
      <div className={`inline-block px-3 py-1 rounded-full text-[10px] font-bold tracking-widest uppercase mb-2 ${color} backdrop-blur-md bg-opacity-90`}>
        {tag}
      </div>
...
export default function EbookStore() {
  const ebooks = [
    ...
    },
    {
      ...
      tag: "Recipes",
      color: "bg-orange-100 text-orange-600",
      bgImage: "https://images.unsplash.com/photo-1547592166-23ac45744acd?q=80&w=800&auto=format&fit=crop"
    },
    {
      ...
      tag: "Recipes",
      color: "bg-orange-100 text-orange-600",
      bgImage: "https://images.unsplash.com/photo-1551024601-bec78aea704b?q=80&w=800&auto=format&fit=crop"
    },
    {
    ...
    },
    {
      ...
      tag: "Protocol",
      color: "bg-blue-100 text-blue-600",
      bgImage: "https://www.cspi.org/sites/default/files/styles/700x530/public/2022-02/terovesalainen_AdobeStock_exerciseApp_352235085_hero_700x530.jpg.webp?itok=pauD9qqF"
    },
    {
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-slate-500 max-w-xl mx-auto text-lg font-medium">
            Expertly crafted protocols designed to optimize your family's health.
          </p>
        </div>
            ...
            <div className="relative z-10 p-8 md:p-16 flex flex-col md:flex-row justify-between items-start md:items-center w-full gap-12">
              <div className="max-w-xl space-y-6">
                ...
                <ul className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-sm font-bold pt-4">
                  {["6 Best-Selling Ebooks", "Lifetime Access", "Mobile-Friendly PDF", "Instant Download"].map((item) => (
                    <li key={item} className="flex items-center gap-2">
                      <CheckCircle2 className="text-[#3E7D72] bg-white rounded-full" size={20} /> {item}
                    </li>
                  ))}
                </ul>
              </div>
        ...
        <div className="mb-12 flex items-center gap-4">
          <h4 className="text-xs font-black text-slate-400 uppercase tracking-[0.4em] whitespace-nowrap">Individual Guides</h4>
